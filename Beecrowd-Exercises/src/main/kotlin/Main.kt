...
* letra 'y' deve virar caractere '|' e assim sucessivamente. Na segunda passada, a linha deverá
* ser invertida. Na terceira e última passada, todo e qualquer caractere a partir da metade em
* diante (truncada) devem ser deslocados uma posição para a esquerda na tabela ASCII. Neste caso,
* 'b' vira 'a' e 'a' vira '`'.
*
...
* inteiro N (1 ≤ N ≤ 1*104), indicando a quantidade de linhas que o problema deve tratar.
